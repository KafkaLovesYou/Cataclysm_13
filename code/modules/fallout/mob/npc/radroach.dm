...
/mob/living/simple_animal/hostile/radroach
	name = "radroach"
	desc = "Great American cockroaches, colloquially called radroaches or giant cockroaches, are giant versions of the cockroach species that have been mutated by radiation."
