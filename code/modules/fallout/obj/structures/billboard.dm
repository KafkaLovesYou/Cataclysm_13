...
/obj/structure/billboard/ritas
	...
	desc = "A defaced ad for Rita's Cafe.<br>The wasteland has taken its toll on the board."
	icon_state = "ritas1"
...
/obj/structure/billboard/ritas/pristine
	...
	desc = "An ad for Rita's Cafe.<br>Oddly enough, it's good as new."
	icon_state = "ritas1"
...
/obj/structure/billboard/cola
	...
	desc = "A defaced ad for Nuka-Cola.<br>The wasteland has taken its toll on the board."
	icon_state = "cola1"
...
/obj/structure/billboard/cola/pristine
	...
	desc = "An ad for Nuka-Cola.<br>Oddly enough, it's good as new."
	icon_state = "cola1"
