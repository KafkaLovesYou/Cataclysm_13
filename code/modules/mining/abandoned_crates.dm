...
/obj/structure/closet/crate/secure/loot/New()
	...
	switch(loot)
		...
		if(11 to 15)
			new /obj/item/weapon/reagent_containers/glass/jerrycan/large(src)
		if(16 to 20)
		...
		if(26 to 30)
			for(var/i in 1 to 3)
				new /obj/item/weapon/reagent_containers/glass/jerrycan(src)
		if(31 to 34)
			for(var/i in 1 to 4)
				new /obj/effect/spawner/lootdrop/military(src)
		if(35 to 40)
		...
		if(46 to 50)
			for(var/i in 1 to 3)
				new /obj/effect/spawner/lootdrop/science(src)
			new /obj/effect/spawner/lootdrop/science/highvalue(src)
