...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("chair", /obj/structure/chair, one_per_turf = 2, on_floor = 1), \
/*	new/datum/stack_recipe("swivel chair", /obj/structure/chair/office/blue, 5, one_per_turf = 1, on_floor = 1), \*/
	new/datum/stack_recipe("comfy chair", /obj/structure/chair/comfy/beige, 3, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("bed", /obj/structure/bed, 4, one_per_turf = 1, on_floor = 1), \
	null, \
	new/datum/stack_recipe("rack parts", /obj/item/weapon/rack_parts), \
	new/datum/stack_recipe("closet", /obj/structure/closet, 4, time = 15, one_per_turf = 1, on_floor = 1), \
	null, \
/*	new/datum/stack_recipe("canister", /obj/machinery/portable_atmospherics/canister, 10, time = 15, one_per_turf = 1, on_floor = 1), \
	null, \*/
	new/datum/stack_recipe("metal rod", /obj/item/stack/rods, 1, 2, 60), \
	new/datum/stack_recipe("floor tile", /obj/item/stack/tile/plasteel, 1, 4, 20), \
	new/datum/stack_recipe("nails", /obj/item/stack/nails, 1, 8, 40), \
	null, \
	new/datum/stack_recipe("sheet metal door", /obj/structure/simple_door/metal, 10, time = 30, one_per_turf = 1, on_floor = 0), \
	new/datum/stack_recipe("barred metal door", /obj/structure/simple_door/metal/barred, 10, time = 30, one_per_turf = 1, on_floor = 0), \
	null, \
	new/datum/stack_recipe("lock", /obj/item/weapon/lock_construct, 1, time = 10, one_per_turf = 0, on_floor = 0), \
	new/datum/stack_recipe("key", /obj/item/weapon/key, 1, time = 10, one_per_turf = 0, on_floor = 0), \
...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("strong wooden barricade", /obj/structure/barricade/wooden/strong, 10, time = 100, one_per_turf = 1, on_floor = 1), \
		null, \
	new/datum/stack_recipe("simple door", /obj/structure/simple_door/wood, 10, time = 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("standard door", /obj/structure/mineral_door/wood, 15, time = 30, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("exterior door", /obj/structure/simple_door/house, 10, time = 30, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("interior door", /obj/structure/simple_door/interior, 10, time = 30, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("room door", /obj/structure/simple_door/room, 10, time = 30, one_per_turf = 1, on_floor = 1), \
		null, \
	...
	new/datum/stack_recipe("dresser", /obj/structure/dresser, 5, time = 15, one_per_turf = 1, on_floor = 1), \
...
/*	new/datum/stack_recipe("dufflebag", /obj/item/weapon/storage/backpack/dufflebag, 6), \
	...
	null, \
	new/datum/stack_recipe("backpack", /obj/item/weapon/storage/backpack, 8), \
	new/datum/stack_recipe("bedsheet", /obj/item/weapon/bedsheet, 4), \
	new/datum/stack_recipe("mattress", /obj/structure/bed/mattress, 20), \
	new/datum/stack_recipe("empty sandbag", /obj/item/weapon/emptysandbag, 4), \
	null, \
	new/datum/stack_recipe("fingerless gloves", /obj/item/clothing/gloves/fingerless, 1), \
	new/datum/stack_recipe("gloves", /obj/item/clothing/gloves/color/grey, 3), \
	)
...
var/global/list/datum/stack_recipe/cardboard_recipes = list ( \
	...
	new/datum/stack_recipe("empty first aid box", /obj/item/weapon/storage/firstaid/regular), \
