...
/obj/effect/spawner/lootdrop/maintenance
	...
	loot = list(
				...
				/obj/item/clothing/glasses/sunglasses = 0.1,
				...
				/obj/item/device/flashlight/red = 2,
				...
				/obj/item/stack/rods{amount = 23} = 5,
				/obj/item/stack/rods{amount = 50} = 4,
				...
				/obj/item/weapon/hand_labeler = 0.5,
				/obj/item/weapon/paper/crumpled = 9,
				//obj/item/weapon/pen = 1,
				/obj/item/weapon/reagent_containers/spray/pestspray = 1,
				/obj/item/weapon/reagent_containers/glass/rag = 4,
				/obj/item/weapon/stock_parts/cell = 3,
				/obj/item/weapon/storage/belt/utility = 0.2,
				...
				/obj/item/weapon/storage/toolbox/mechanical = 0.25,
				...
				/obj/item/device/geiger_counter = 4,
